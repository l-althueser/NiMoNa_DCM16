...
\section{Dynamic causal modelling (DCM) für das funktionelle Magnetresonanztomographie (fMRI)-Modell - Rückblick}
...
\item \textit{Auflösung kurzzeitiger Gehirnaktivität} 
\end{itemize}
\end{frame}
