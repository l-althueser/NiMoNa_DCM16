...
Grafik folgt.
Ziel: Für ein 3 Regionen Netzwerk den Unterschied zwischen dem nicht-linear und dem bilinearen Modell zeigen. Ggf weitere Reduktion der Modellparameter. Grenzfall zum sehr nichtlinearen Verhalten ausprobieren. Ggf. den Einfluss von Parametern auf die Stabilität testen..
Anpassen der Zeitschrittlänge - starker Einfluss auf die Rechenzeit. 10 mal mehr Schritt bringt vielfach mehr Rechenzeit. 
lapidare Fragestellung: Was bringt die nichtlineare Erweiterung.
weiteres Ziel: Es müssten schnelle Tests möglich sein, ohne jedes Mal das Programm umzuschreiben. 
Problem: Kann es sein, dass die Zeitschrittlänge nur mehr Zeiten anhängt und nicht für mehr Schritte sorgt. 
