...
plt.plot(t,xlin[3,:],'--k',label='Region 2/4 (lineares Modell)',linewidth=2)     #Gehirnaktivität
...
plt.plot(t,ylin[3,:],'--k',label='Region 2/4 (lineares Modell)',linewidth=2)      #BOLD-Signal
